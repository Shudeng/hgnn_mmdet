...
CUDA_VISIBLE_DEVICES=$1 python -m torch.distributed.launch --nproc_per_node=$2 --master_port=29716 ./tools/train.py configs/votenet/votenet_16x8_sunrgbd-3d-10class.py --launcher pytorch --work-dir knn_gan_gumbel_bn_50 #--resume-from knn_gan_layernorm_1/latest.pth
